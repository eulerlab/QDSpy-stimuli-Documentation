...
p = {"nTrials"         : 1,           # number of stimulus presentations 
     ...
     "movOrient"       : 90,           # movie orientation
     ...
     "nFrRepeats"      : 2,           # -> 30 fps
     "movName_Test"    : r"C:\Users\eulerlab\QDSpy\Stimuli\Samuel\mouse_cam_like_klaudia\MC2_test_rgb_72x64_left.jpg",
     "movName_Train"   : r"C:\Users\eulerlab\QDSpy\Stimuli\Samuel\mouse_cam_like_klaudia\MC2_train_rgb_72x64_left.jpg",
...
# Define objects
Indices = np.loadtxt(r"C:\Users\eulerlab\QDSpy\Stimuli\Samuel\mouse_cam_like_klaudia\RandomSequences.txt")
UseColumn = 18 # USE COLUMN IDX 18
