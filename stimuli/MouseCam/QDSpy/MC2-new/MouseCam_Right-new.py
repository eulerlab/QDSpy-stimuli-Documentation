...
QDS.Initialize("MouseCam_Right_V3")

# Define global stimulus parameters
#os.chdir("C:\\Users\\teuler\\Documents\\QDSpy-experimental\\Stimuli")
#
...
p = {"nTrials"         : 1,           # number of stimulus presentations
     ...
     "nFrRepeats"      : 2,           # -> 30 fps
     #"movName_Test"    : "//Klaudia//NaturalMovie_RGCs//MC2_test_rgb_72x64_left.jpg",
     #"movName_Train"   : "//Klaudia//NaturalMovie_RGCs//MC2_train_rgb_72x64_left.jpg",
     "movName_Test"    : "MC2_test_rgb_64x72_right-new.jpg",
     "movName_Train"   : "MC2_train_rgb2_64x72_right-new.jpg",
...
# Define objects
#pwd()
#Indices = np.loadtxt("C:Users//teuler//Documents//QDSpy-experimental//Stimuli//RandomSequences.txt")
Indices = np.loadtxt(FILE_DIR / 'RandomSequences.txt')

#Indices = np.loadtxt("C:Users/teuler/Documents/QDSpy-experimental/Stimuli/Klaudia/NaturalMovie_RGCs/RandomSequences.txt")

#Indices = np.loadtxt("RandomSequences.txt")
...
QDS.DefObj_Movie(1, FILE_DIR / p["movName_Test"])
QDS.DefObj_Movie(2, FILE_DIR / p["movName_Train"])
